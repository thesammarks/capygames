...
export const GAMES: GameMeta[] = [
  {
    ...
    live: true,
    glyph: `<svg width="34" height="34" viewBox="0 0 34 34"><g fill="currentColor"><rect x="6" y="2" width="6" height="6" rx="1"/><rect x="22" y="2" width="6" height="6" rx="1"/><rect x="2" y="10" width="30" height="6" rx="1"/><rect x="2" y="18" width="30" height="6" rx="1"/><rect x="9" y="26" width="16" height="6" rx="1"/></g></svg>`,
  },
  {
    id: "nonomini",
    name: "Nonomini",
    ...
    live: true,
    glyph: `<svg width="34" height="34" viewBox="0 0 34 34"><g fill="currentColor"><rect x="9" y="6" width="7" height="7" rx="1.4"/><rect x="6" y="15" width="16" height="7" rx="1.4"/><rect x="11" y="24" width="9" height="7" rx="1.4"/></g></svg>`,
  },
  {
    id: "sudoku",
    name: "Sudoku",
  ...
  },
  {
    ...
    live: true,
    glyph: `<svg width="34" height="34" viewBox="0 0 34 34"><g stroke="var(--yuzu)" stroke-width="2"><line x1="7" y1="7" x2="7" y2="27"/><line x1="7" y1="9" x2="27" y2="9"/><line x1="9" y1="11" x2="25" y2="11"/></g><g fill="currentColor"><circle cx="7" cy="7" r="4.4"/><circle cx="27" cy="7" r="4.4"/><circle cx="7" cy="27" r="4.4"/></g></svg>`,
  },
  {
    id: "kakuro",
    name: "Kakuro",
